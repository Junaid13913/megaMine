...
AUTHORS: Muhammad Junaid — APML, Ajou University, Department of Biomedical Sciences
"""
...
<header class="report-header">
  <div>
    ...
    <div class="report-subtitle">Generated by megaMine v2.0 · APML, Ajou University, Department of Biomedical Sciences</div>
  </div>
  <div class="report-meta">
    <div><span>Patient ID</span>{patient_id}</div>
    <div><span>Cancer type</span>{cancer}</div>
    <div><span>Institution</span>Ajou University, Department of Biomedical Sciences</div>
...
<footer class="report-footer">
  <div>megaMine v2.0 · Patient-guided literature evidence synthesis · APML, Ajou University, Department of Biomedical Sciences, Department of Biomedical Sciences</div>
